...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(self.delegate && [self.delegate respondsToSelector:@selector(optionsViewController:didSelectRow:)]) {
        [self.delegate optionsViewController:self didSelectRow:indexPath.row];
    }
}
