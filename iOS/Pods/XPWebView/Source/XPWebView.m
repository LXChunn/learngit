...
{
    if (self.webViewProxyDelegate && [self.webViewProxyDelegate respondsToSelector:@selector(webView:shouldStartLoadWithRequest:navigationType:)]) {
...
{
    if (self.webViewProxyDelegate && [self.webViewProxyDelegate respondsToSelector:@selector(webViewDidStartLoad:)]) {
...
{
    if (self.webViewProxyDelegate && [self.webViewProxyDelegate respondsToSelector:@selector(webViewDidFinishLoad:)]) {
...
{
    if (self.webViewProxyDelegate && [self.webViewProxyDelegate respondsToSelector:@selector(webView:didFailLoadWithError:)]) {
